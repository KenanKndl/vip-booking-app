                    ...
                    <div className="flex flex-col justify-between gap-10">
                        ...
                        >
                            ...
                            <h2 className="text-4xl font-bold tracking-tight text-white md:text-5xl leading-tight mb-4">
                                {t("titlePart1")} <span className="text-white/50">{t("titlePart2")}</span>
                            </h2>
                        ...
                        >
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="text-xs font-semibold text-white/35 uppercase tracking-widest mb-1">{t("info.companyLabel")}</h3>
                                    <p className="text-sm font-medium text-white/80 leading-relaxed">{t("info.companyName")}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="text-xs font-semibold text-white/35 uppercase tracking-widest mb-1">{t("info.addressLabel")}</h3>
                                    <p className="text-sm font-medium text-white/80 leading-relaxed">{t("info.addressValue")}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="text-xs font-semibold text-white/35 uppercase tracking-widest mb-1">{t("info.phoneLabel")}</h3>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="text-xs font-semibold text-white/35 uppercase tracking-widest mb-1">{t("info.emailLabel")}</h3>
                            ...
                            <form className="flex flex-col gap-5 bg-white/[0.015] border border-white/5 p-8 rounded-3xl shadow-none">
                                <div className="grid gap-5 sm:grid-cols-2">
                                    <div className="flex flex-col gap-2">
                                        <label htmlFor="name" className="text-xs font-medium text-white/40 uppercase tracking-wider pl-1">{t("form.nameLabel")}</label>
                                        <input
                                            type="text"
                                            id="name"
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <label htmlFor="email" className="text-xs font-medium text-white/40 uppercase tracking-wider pl-1">{t("form.emailLabel")}</label>
                                        <input
                                            type="email"
                                            id="email"
                                ...
                                <div className="flex flex-col gap-2">
                                    <label htmlFor="phone" className="text-xs font-medium text-white/40 uppercase tracking-wider pl-1">{t("form.phoneLabel")}</label>
                                ...
                                <div className="flex flex-col gap-2">
                                    <label htmlFor="message" className="text-xs font-medium text-white/40 uppercase tracking-wider pl-1">{t("form.messageLabel")}</label>
                                    <Textarea
                                        id="message"
